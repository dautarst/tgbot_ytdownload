...
def start(message):
    bot.send_message(message.chat.id, "Wake up, Samurai! We have a videos to search! \n /search to start searching YT videos \n /download to start downloading video by URL")
...
def text(message):
    bot.send_message(message.chat.id, "Hi! \n /start to say Hello! \n /search to searching videos on YouTube \n /download to start downloading video by URL")
